...
namespace PillScript.Bridge
{
    ...
    internal static class BridgeLookup
    {
        ...
        public static IEnumerable<PillScriptComponent> Components()
        {
            ...
            foreach (GH_Document document in server)
            {
                ...
                {
                    if (obj is PillScriptComponent component) yield return component;
                }
            }
        }
        ...
        /// </summary>
        public static PillScriptComponent Component(JsonElement arguments)
        {
        ...
        public static object Describe(PillScriptComponent component)
            => new
            {
        ...
        public static object Parameters(PillScriptComponent component)
            => new
            {
